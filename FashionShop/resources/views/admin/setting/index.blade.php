    ...
    <div class="row">
        <div class="col-md-12 grid-margin">
            ...
            <form action="{{ url('admin/settings') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label>Address</label>
                                <textarea type="address" name="address" class="form-control" rows="3">{{ $setting->address ?? '' }}</textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Phone 1*</label>
                ...
                <div class="card mb-3">
                    <div class="card-header bg-primary">
                        <h3 class="text-white mb-0">Card Credit</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label>Master Cart (Optional)</label>
                                <input type="text" name="master_cart" value="{{ $setting->master_cart ?? '' }}" class="form-control">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Visa (Optional)</label>
                                <input type="text" name="visa" value="{{ $setting->visa ?? '' }}" class="form-control">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Paypal (Optional)</label>
                                <input type="text" name="paypal" value="{{ $setting->paypal ?? '' }}" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
