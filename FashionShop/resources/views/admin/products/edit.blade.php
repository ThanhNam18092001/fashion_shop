                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade boder p-3 show active" id="home" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" name="small_description" rows="4" class="form-control">{{ $product->small_description }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" name="description" rows="4" class="form-control">{{ $product->description }}</textarea>
                                    @error('description')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.deleteProductColorBtn', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        thisClink.closest('.prod-color-tr').remove();
                    }
                })
            });
        });
