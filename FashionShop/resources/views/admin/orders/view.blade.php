...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="card-header">
                    <h3>My Orders Detail
                        ...
                        <a href="{{ url('admin/invoice/'.$order->id.'/generate') }}"
                            class="btn btn-primary text-white btn-sm float-end">Download Invoice</a>
                        <a href="{{ url('admin/invoice/'.$order->id) }}" target="_blank"
                            class="btn btn-warning text-white btn-sm float-end">View Invoice</a>
                    </h3>
                    </h3>
                </div>
            ...
            <div class="card">
                <div class="cart-body">
                    <h4>Order Process (Oder Status Updates)</h4>
                    <hr>
                    <div class="row">
