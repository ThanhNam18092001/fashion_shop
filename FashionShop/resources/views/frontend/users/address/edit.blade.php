@extends('layouts.app')
<link rel="stylesheet" href="{{ asset('assets/css/frontend/address/edit.css') }}" rel="stylesheet">
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="menu_container">
                    ...
                    <div class="col-md-10 address_edit_container">
                        <h4>My Address</h4>
                        <form action="{{ url('/address/' . $address->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="checkbox" name="status" {{ $address->status == '1' ? 'checked' : '' }}>Set as
                            default address
                            <br>
