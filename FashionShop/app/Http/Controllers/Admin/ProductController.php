...
class ProductController extends Controller
{
    ...
    public function store(ProductFormRequest $request)
    {
        ...
        return redirect('/admin/products')->with('message', 'Category Added Successfully');
    }
    ...
    public function edit(int $product_id)
    {
        ...
        return view('admin.products.edit', compact('categories', 'brands', 'product', 'color'));
    }
    ...
    public function update(ProductFormRequest $request, int $product_id)
    {
        ...
        if ($product) {
            ...
            return redirect('/admin/products/create')->with('message', 'Category Update Successfully');
        } else {
